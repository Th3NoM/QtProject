...
namespace {
struct qt_meta_tag_ZN12DBConnectionE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12DBConnectionE = QtMocHelpers::stringData(
    "DBConnection"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12DBConnectionE[] = {
...
Q_CONSTINIT const QMetaObject DBConnection::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12DBConnectionE.offsetsAndSizes,
    qt_meta_data_ZN12DBConnectionE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12DBConnectionE_t,
        // Q_OBJECT / Q_GADGET
...
void *DBConnection::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12DBConnectionE.stringdata0))
